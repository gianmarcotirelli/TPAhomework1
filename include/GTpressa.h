 ...
 * angle = angolo per determinare il modo di assemblaggio del meccanismo. Siriferisce all'angolo tra l2 e la verticale 
...
/**
 *Restituisce una string di codice SVG per disegnare il meccanismo 
 */
